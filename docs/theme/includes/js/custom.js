...
setTimeout(function(){
	$(document).ready(function() {
		...
		setTimeout(function(){
			...
			if( parseInt($(".nav-list-link.active").attr('cur-pg') - 1) != NaN && parseInt($(".nav-list-link.active").attr('cur-pg') - 1) == pg_en)
				$('.ept_pn').hide();
			else
				$('.ept_pn').show();
			if(parseInt($(".nav-list-link.active").attr('cur-pg') - 1) != NaN && parseInt($(".nav-list-link.active").attr('cur-pg') - 1) == pg_st)
				$('.ept_pp').hide();
			else
				$('.ept_pp').show();
